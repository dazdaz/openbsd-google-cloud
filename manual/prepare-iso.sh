...
# OpenBSD ISO Preparation Script
# This script handles ISO download and verification
...
OpenBSD ISO Preparation Script - Downloads and verifies OpenBSD ISO
...
download_openbsd_iso() {
    ...
    log_info "OpenBSD ISO downloaded successfully: ${iso_file}"
    echo "${iso_file}"
}
...
main() {
    ...
    if [[ $? -eq 0 ]]; then
        log_info "ISO preparation completed successfully"
